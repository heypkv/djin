// Package webui embeds the built web UI (source in ui/, built with Vite into
// this package's dist/) and serves it. Until the real UI lands, dist/ holds a
// committed placeholder index.html so the binary builds and serves standalone.
package webui
